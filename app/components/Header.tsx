...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 glass-effect border-b border-[var(--border-color)]">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden glass-effect border-t border-[var(--border-color)]">
